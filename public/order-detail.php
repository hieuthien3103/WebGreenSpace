...
if (!function_exists('order_detail_order_status_meta')) {
...
if (!function_exists('order_detail_payment_status_meta')) {
...
if (!function_exists('order_detail_payment_method_label')) {
