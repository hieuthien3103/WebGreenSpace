        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <div class="flex gap-4">
                    <a href="<?= base_url('products') ?>" class="px-8 py-4 bg-primary text-white rounded-full font-bold hover:bg-primary-dark transition-all shadow-lg shadow-primary/30">
                        Xem sản phẩm
                    </a>
            ...
            <div class="relative">
                <img src="<?= image_url('banners/banner_home.png') ?>" alt="Plants" class="rounded-3xl shadow-2xl" onerror="this.src='https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=800&amp;q=80'">
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 bg-white dark:bg-[#0f1612]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <article class="group bg-white dark:bg-[#1e2b24] rounded-2xl overflow-hidden border border-transparent hover:border-[#e9f2ec] dark:hover:border-gray-700 hover:shadow-xl transition-all duration-300">
                        <a href="<?= base_url('product/' . $product['slug']) ?>" class="block">
                            <div class="relative aspect-[4/5] overflow-hidden bg-gray-100 dark:bg-gray-800">
                                <img src="<?= clean($product['image_url'] ?? image_url('products/default.jpg')) ?>" alt="<?= clean($product['name']) ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                            <div class="p-4">
        ...
        <div class="text-center mt-12">
            <a href="<?= base_url('products') ?>" class="inline-flex items-center gap-2 px-8 py-3 bg-primary text-white rounded-full font-bold hover:bg-primary-dark transition-all">
                Xem tất cả sản phẩm
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            <?php if (!empty($categories)): ?>
                <?php foreach ($categories as $category): ?>
                    <a href="<?= base_url('category/' . $category['slug']) ?>" class="group text-center">
