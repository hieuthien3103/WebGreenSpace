...
Dự án GreenSpace được thực hiện bởi hai sinh viên trong khoảng thời gian một học phần (khoảng 3-4 tháng).
Phân công công việc như sau:

\begin{itemize}[leftmargin=*]
    \item \textbf{Sinh viên 1:} Chịu trách nhiệm phát triển phần Back-end, thiết kế cơ sở dữ liệu, 
          xây dựng các Service Layer và Controller cho luồng mua hàng, quản trị đơn hàng.
    \item \textbf{Sinh viên 2:} Chịu trách nhiệm phát triển phần Front-end, thiết kế giao diện người dùng,
          triển khai AJAX, CSS responsive và các trang admin quản trị.
\end{itemize}

Trong giai đoạn cuối, cả hai sinh viên cùng tiến hành kiểm thử, viết tài liệu và chuẩn bị báo cáo.
Việc sử dụng Git Flow giúp các thành viên làm việc song song mà không gây xung đột code.
Các buổi họp định kỳ hằng tuần đảm bảo tiến độ đồng bộ và giải quyết các vướng mắc kỹ thuật.
...
\texttt{PHP 8.3.6}, \texttt{Nginx}, \texttt{MySQL 8}, dữ liệu mẫu 10 sản phẩm,
