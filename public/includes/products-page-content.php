<div id="productsPageContent" data-page-title="<?= clean($pageTitle) ?>" class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <!-- Search Box -->
            <form method="GET" action="/products.php" class="relative" data-products-search-form="true">
                <input type="text"
                       name="search"
                       value="<?= clean($search) ?>"
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <details class="group bg-white dark:bg-[#1e2b24] rounded-xl border border-[#e9f2ec] dark:border-gray-800 overflow-hidden" open>
                        ...
                        <div class="px-4 pb-4 pt-0 text-sm space-y-2 text-text-secondary">
                            <a href="/products.php" data-products-ajax-link="true" class="flex items-center gap-3 cursor-pointer hover:text-primary transition-colors py-1 <?= empty($category_filter) ? 'text-primary font-semibold' : '' ?>">
                ...
                <?php else: ?>
                    <div class="col-span-full text-center py-16">
                        ...
                        <?php if (!empty($search)): ?>
                            ...
                            <a href="/products.php" data-products-ajax-link="true" class="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-full hover:bg-primary-dark transition-colors">
