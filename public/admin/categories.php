...
$allParentOptions = $categoryModel->getAdminParentOptions(null);

$categoryListStateUrl = 'categories.php' . admin_categories_query([
    'q' => $search,
    'status' => $statusFilter,
    'page' => $page,
]);

$defaultCategoryFormState = admin_category_defaults();
$defaultCategoryFormState['id'] = '';
$defaultCategoryFormState['image_url'] = image_url('categories/default.jpg');
$defaultCategoryFormState['site_url'] = '';
