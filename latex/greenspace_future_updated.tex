...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{3.0cm}
        ...
        Thông tin chăm sóc cây & Sơ lược & Không có & Sơ lược & Chi tiết (ánh sáng, nước, mức độ) \\ \hline
        ...
        Mã giảm giá (Coupon) & Không & Không & Có & Có (phần trăm \& cố định) \\ \hline
...
\begin{table}[H]
    ...
    \vspace{0.3cm}
    \begin{tabularx}{\linewidth}{|>{\centering\arraybackslash}p{0.7cm}
...
\begin{table}[H]
    ...
    \vspace{0.3cm}
    \begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{3.2cm}|Y|Y|}
        \hline
...
\setlength{\LTpre}{0pt}
\setlength{\LTpost}{0pt}
\begin{longtable}{|p{1.2cm}|p{4.2cm}|p{3.6cm}|p{3.6cm}|}
...
\setlength{\LTpre}{0pt}
\setlength{\LTpost}{0pt}
\begin{longtable}{|p{3.0cm}|p{1.8cm}|p{4.0cm}|p{3.8cm}|}
